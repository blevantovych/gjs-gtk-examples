...
{
    var [success, start, end] = textbuffer.get_selection_bounds();
...
radiobuttonWrapNone.connect("toggled", function() {on_wrap_mode_changed(radiobuttonWrapNone)});
...
radiobuttonWrapChar.connect("toggled", function() {on_wrap_mode_changed(radiobuttonWrapChar)});
...
radiobuttonWrapWord.connect("toggled", function() {on_wrap_mode_changed(radiobuttonWrapWord)});
...
radiobuttonWrapWordChar.connect("toggled", function() {on_wrap_mode_changed(radiobuttonWrapWordChar)});
